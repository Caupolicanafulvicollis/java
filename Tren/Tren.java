...
public class Tren extends JFrame {
        ...
        boton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (nombre.equals("") || rut.equals("") || distancia.equals("") || dias.equals("")) {
                    JOptionPane.showMessageDialog(null, "Debe ingresar todos los datos solicitados", "Información",
    ...
    // Método principal (main) para ejecutar la ventana
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            Tren trenFrame = new Tren();
            trenFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            trenFrame.setSize(600, 400); // Tamaño ajustado para los componentes
            trenFrame.setVisible(true);
        });
    }
}
